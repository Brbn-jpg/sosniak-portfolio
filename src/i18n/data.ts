...
export const skillsData: Record<Lang, { title: string; subtitle: string }[]> = {
  en: [
    {
      title: "Sales Team Leadership & Development",
      subtitle:
        "I built and restructured sales departments: from recruitment through day-to-day team management to people development.",
    },
    {
      title: "Business Development & Growth Strategy",
      subtitle:
        "I opened new market segments, built pipelines, and found revenue where others didn't see it.",
    },
    {
      title: "Key Accounts & KOL Management",
      subtitle:
        "I managed key accounts and relationships with opinion leaders in clinical and veterinary laboratories.",
    },
    {
      title: "P&L & Budget Management",
      subtitle:
        "Full accountability for financial results: from budget planning to daily decisions impacting profitability.",
    },
    {
      title: "Customer Segmentation & Pricing",
      subtitle:
        "I segmented customers and built pricing policies that made business sense, not just commercial sense.",
    },
    {
      title: "Distribution Network Management",
      subtitle:
        "I managed a distribution network across 7 NEEU countries: from partner selection to target execution.",
    },
    {
      title: "Product & Application Knowledge",
      subtitle:
        "Clinical chemistry, haematology, haemostasis, immunochemistry. I know these areas from the laboratory side and the product side.",
    },
    {
      title: "Market Analysis & Competitive Strategy",
      subtitle:
        "I analysed markets and competition to make decisions based on data, not gut feeling.",
    },
  ],
  pl: [
    {
      title: "Przywództwo i rozwój zespołu sprzedaży",
      subtitle:
        "Budowałem i restrukturyzowałem działy sprzedaży — od rekrutacji po codzienną pracę z zespołem i rozwój ludzi.",
    },
    {
      title: "Rozwój biznesu i strategia wzrostu",
      subtitle:
        "Otwierałem nowe segmenty rynku, budowałem pipeline i szukałem przychodów tam gdzie inni ich nie widzieli.",
    },
    {
      title: "Kluczowi klienci i zarządzanie KOL",
      subtitle:
        "Zarządzałem kluczowymi klientami i relacjami z liderami opinii w laboratoriach klinicznych i weterynaryjnych.",
    },
    {
      title: "Zarządzanie P&L i budżetem",
      subtitle:
        "Pełna odpowiedzialność za wynik finansowy — od planowania budżetu po codzienne decyzje wpływające na rentowność.",
    },
    {
      title: "Segmentacja klientów i polityka cenowa",
      subtitle:
        "Segmentowałem klientów i budowałem politykę cenową która miała sens biznesowy, nie tylko handlowy.",
    },
    {
      title: "Zarządzanie siecią dystrybucji",
      subtitle:
        "Zarządzałem siecią dystrybucji w 7 krajach regionu NEEU — od wyboru partnerów po egzekucję celów.",
    },
    {
      title: "Wiedza produktowa i aplikacyjna",
      subtitle:
        "Chemia kliniczna, hematologia, hemostaza, immunochemia — znam te obszary od strony laboratorium i od strony produktu.",
    },
    {
      title: "Analiza rynku i strategia konkurencyjna",
      subtitle:
        "Analizowałem rynek i konkurencję żeby podejmować decyzje oparte na danych, nie na przeczuciach.",
    },
  ],
};
...
export const experienceData: Record<Lang, Experience[]> = {
  en: [
    ...
    },
    {
      ...
      location:
        "Opole region: Gynaecology-Obstetrics Hospital, Neuropsychiatric Hospital",
      current: false,
      highlights: [
  ...
  pl: [
    ...
    },
    {
      ...
      company: "Diagnostyka Sp. z o.o.",
      location:
        "Woj. Opolskie — Szpital Ginekologiczno-Położniczy, Szpital Neuropsychiatryczny",
      current: false,
      highlights: [
...
export const earlierCareer: Record<
  Lang,
  ...
  en: [
    {
      period: "2005–2006",
      role: "Assistant",
      company: "LOMA Laboratorium Medyczne",
    },
    {
      period: "2004–2005",
      role: "Medical Representative",
      company: "Servier Sp. z o.o.",
    },
    {
      period: "2000–2004",
      role: "Laboratory Manager",
      company: "Wojewódzki Szpital Chorób Płuc i Gruźlicy",
    },
  ],
  pl: [
    {
...
export const educationData: Record<Lang, { degrees: Degree[]; certs: Cert[] }> =
  {
    en: {
      degrees: [
        ...
        {
          degree: "Clinical Laboratory Diagnostician Specialist",
          institution: "Wrocław Medical University",
          years: "2006–2009",
          icon: iconLab,
          highlight: "clinical",
        },
        {
          degree: "Postgraduate – Business Management",
    ...
    pl: {
      degrees: [
        ...
        {
          degree: "Specjalista Diagnostyki Laboratoryjnej",
          institution: "Akademia Medyczna we Wrocławiu",
          years: "2006–2009",
          icon: iconLab,
          highlight: "clinical",
        },
        {
          degree: "Podyplomowe – Zarządzanie jednostkami gospodarczymi",
